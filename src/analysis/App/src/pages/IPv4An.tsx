    ...
    return (
        <div className="Analysis">
            ...
            <div className='description'>
                ...
                <p>These graphs can grow quite large, so scrolling may be needed. It is usual for an IPv4 graph to be</p>
                <p>more dense than its IPv6 counterpart, though this is not always the case.</p>
            </div>
