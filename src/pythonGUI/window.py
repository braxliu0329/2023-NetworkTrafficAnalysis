...
"")
        ...
        self.actionFollowStream = QtWidgets.QAction(MainWindow)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("src/pythonGUI/Icons/footprint.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFollowStream.setIcon(icon)
        self.actionFollowStream.setObjectName("actionFollowStream")
        ...
        self.toolBar.addAction(self.actionFollowStream)
